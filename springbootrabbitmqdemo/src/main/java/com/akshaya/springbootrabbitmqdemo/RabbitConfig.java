...
public class RabbitConfig implements RabbitListenerConfigurer {
    ...
    //create obj for BeanA class
    //BeanA beanA=new BeanA()
    @Bean(name="beanAfirstObject")
    public BeanA beanA(){
    	BeanA beanA=new BeanA();
    	beanA.setName("beanAName");
    	return beanA;
    }
    
    @Bean(name="beanAsecondObject")
    public BeanA beanAsecondObject(){
    	BeanA beanA=new BeanA();
    	beanA.setName("beanAsecondObject");
    	return beanA;
    }
